                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 40px; align-items: start;">
                            <div class="video-card">
                                <div style="resize: both; overflow: hidden; max-width: 100%; border: 3px solid #800080; box-shadow: 0 0 15px #FF8C00; border-radius: 12px; background: #000; margin-bottom: 20px;">
                                    <video controls preload="metadata" playsinline muted style="width: 100%; height: 100%; display: block; object-fit: contain;" src="PRESENTACION%20AMANECER.mp4#t=6" onplay="if(!this.playedOnce){this.currentTime=0;this.playedOnce=true;}"></video>
                                </div>
                            ...
                            <div class="video-card">
                                <div style="resize: both; overflow: hidden; max-width: 100%; border: 3px solid #800080; box-shadow: 0 0 15px #FF8C00; border-radius: 12px; background: #000; margin-bottom: 20px;">
                                    <video controls preload="metadata" playsinline muted style="width: 100%; height: 100%; display: block; object-fit: contain;" src="CIRCULO%20CLASIFICATORIO%20COMPLETO.mp4#t=5.5" onplay="if(!this.playedOnce){this.currentTime=0;this.playedOnce=true;}"></video>
                                </div>
