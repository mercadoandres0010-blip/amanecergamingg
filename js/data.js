const INITIAL_DATA = {
    ...
    squads: [
        {
            ...
            roster: {
                starters: [
                    { name: "Kyse2K.", role: "Jungla", photo: "images/kyse2k.jpeg", specialty: "Suyou", bio: "Hola soy Kyse2K. (mas conocido como mono con navaja o valen) soy main jg pero juego mejor fuera de la partida, mi héroe favorito es suyou pq es muy versátil y bueno soy la vrg de jg", highlightVideo: "video/video-mejor-jugada.mp4" },
                    ...
                    { name: "ᴀʏᴀɴᴀᴍɪ.", role: "Mid Lane", photo: "images/ayanami.jfif", specialty: "Gord", bio: "soy ayanami, soy main y mid me gusta mucho gord pq es medio inútil y me representa" },
                    { name: "ToquinhoSSJ:v", role: "Gold Lane (Líder)", photo: "images/toquinho.jpeg", specialty: "Moskov", bio: "Soy Toqui, soy main moskov y a su vez es mi pj favorito, me gusta mucho por su movilidad y la facilidad de poder hacer separar a los enemigos" },
    ...
    team: [
        ...
        { name: "Rxdriii", role: "Asistencia y Logística", photo: "images/rodri-logistica.jpeg", bio: "Predispuesto a aprender y ser de máxima ayuda posible, desempeñando mis labores con total entrega." },
        { name: "Tomioka", role: "Casteo y Stream", photo: "images/tomioka-stream.jpeg", bio: "Vendedor nato y social. Me gusta crear un ambiente agradable donde los espectadores se rían con mis ocurrencias." },
        { name: "Vert", role: "Asistencia y Logística", photo: "images/vert-logistica.jpeg", bio: "Participativo y en constante movimiento. Desempeño mi trabajo con seriedad pero sin perder la alegría que me caracteriza." }
    ],
    games: [
