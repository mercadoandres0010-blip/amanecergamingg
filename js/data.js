const INITIAL_DATA = {
    ...
    squads: [
        {
            ...
            roster: {
                starters: [
                    { name: "Kyse2K.", role: "Jungla", photo: "images/Kyse2K..jpeg", specialty: "Suyou", bio: "Hola soy Kyse2K. (mas conocido como mono con navaja o valen) soy main jg pero juego mejor fuera de la partida, mi héroe favorito es suyou pq es muy versátil y bueno soy la vrg de jg", highlightVideo: "video/video de mejor jugada.mp4" },
                    { name: "Jszy", role: "Exp Lane", photo: "images/Jszy..jpeg", specialty: "Badang", bio: "Hola, soy Jszy. Soy \"main\" Exp y mi personaje favorito es Badang, aunque me caigo mucho a pedazos, me gusta mucho por el simple hecho de salir de la nada y armar tf, o regalarme como un campeon." },
                    { name: "ᴀʏᴀɴᴀᴍɪ.", role: "Mid Lane", photo: "images/ᴀʏᴀɴᴀᴍɪ..jfif", specialty: "Gord", bio: "soy ayanami, soy main y mid me gusta mucho gord pq es medio inútil y me representa" },
                    { name: "ToquinhoSSJ:v", role: "Gold Lane (Líder)", photo: "images/ToquinhoSSJv.jpeg", specialty: "Moskov", bio: "Soy Toqui, soy main moskov y a su vez es mi pj favorito, me gusta mucho por su movilidad y la facilidad de poder hacer separar a los enemigos" },
                    { name: "Aagod.", role: "Roamer", photo: "images/Aagod.jpeg", specialty: "Grock / Khaleed", bio: "Soy Aagod. Mi Main es grock pero mi personaje favorito es khaleed por la movilidad y la posibilidad de jugar agro" }
                ],
                substitutes: [
                    { name: "Matinho.", role: "Roam Suplente", photo: "images/Matinho.jpeg", specialty: "Roam", bio: "" }
                ],
                managers: [
                    { name: "Mia", role: "Manager Amanecer", photo: "images/mia_squad.jpeg.jpeg", bio: "Sociable, empática y perfeccionista. Encargada de gestionar y acompañar al squad de Amanecer." },
                    { name: "Rxdriii", role: "Manager Amanecer", photo: "images/rodri.jpeg", bio: "Siempre predispuesto a ayudar y garantizar que al equipo competitivo no le falte nada." }
                ]
            },
            achievements: [
        ...
        },
        {
            ...
            roster: {
                starters: [
                    { name: "Akenoholic. ౨ৎ", role: "Jungla", photo: "images/Akenoholic. ౨ৎ.jpeg", specialty: "Fanny / Franco", bio: "Soy main Fanny, y mi personaje favorito es Franco." },
                    ...
                    { name: "•|Y̷o̷u̷t̷h̷", role: "Roamer", photo: "images/•Y̷o̷u̷t̷h̷.jpeg", specialty: "Grock", bio: "Liga mvp, glamur, torneos por diamantes y por plata" }
                ],
                substitutes: [],
                managers: [
    ...
    team: [
        { name: "Akaza", role: "Edición y Programación", photo: "images/andres edicion y programacion.jpeg", bio: "Soy una persona que siempre aspira a más, me encanta ir por todo y darlo todo, siempre pensando en cosas cada vez más grandes y mejores hechas." },
        { name: "Anto", role: "Marketing y Diseño", photo: "images/anto marketing y diseño.jpeg", bio: "Capaz de amoldarme a cualquier situación. Resolutiva, responsable y diligente. Me apasiona ayudar en todo lo posible." },
        { name: "Dami", role: "Casteo y Stream", photo: "images/dami casteo y stream.jpeg", bio: "Disfruto crear sinergias con mis compañeros para que todo fluya. Atento al chat para mejorar en tiempo real junto a los espectadores." },
        { name: "Bel", role: "Gabinete Psicológico y Admin de eSports", photo: "images/gabinete psicologico y admin de sports.jpeg", bio: "Empática y en constante aprendizaje. Mi meta es ayudar a tener un buen mental ante cualquier escenario competitivo." },
        { name: "Jona", role: "Casteo y Stream", photo: "images/jona cateo y stream.jpeg", bio: "Proactivo y enfocado en brindar una experiencia atractiva. Mi formación técnica me permite dar lo mejor en cualquier escenario." },
        { name: "Mia", role: "Marketing y Diseño", photo: "images/mia_marketing_diseno.jpeg.jpeg", bio: "Sociable, empática y perfeccionista. Me gusta el trabajo en equipo y aprender constantemente de los procesos de Amanecer." },
        { name: "Pink", role: "Marketing y Diseño", photo: "images/pink marketing y diseño.jpeg", bio: "Amanecer nace para dar respuesta a la necesidad de la comunidad de tener un espacio para jugar, competir y socializar." },
        { name: "Rxdriii", role: "Asistencia y Logística", photo: "images/rxdriii_logistica.jpeg.jpeg", bio: "Predispuesto a aprender y ser de máxima ayuda posible, desempeñando mis labores con total entrega." },
        { name: "Tomioka", role: "Casteo y Stream", photo: "images/tomioka casteo y stream.jpeg", bio: "Vendedor nato y social. Me gusta crear un ambiente agradable donde los espectadores se rían con mis ocurrencias." },
        { name: "Vert", role: "Asistencia y Logística", photo: "images/vert asistencia y logististica.jpeg", bio: "Participativo y en constante movimiento. Desempeño mi trabajo con seriedad pero sin perder la alegría que me caracteriza." }
    ],
    games: [
    ...
    tournaments: [
        {
            ...
            image: 'images/logo TORNEO DE VERANO (1).png',
            game: 'mlbb',
            format: 'bracket',
            status: 'proximamente',
            prize: '100.000 ARG',
        ...
        },
        {
            ...
            image: 'images/logo TORNEO SAN VALENTIN (1).png',
            game: 'mlbb',
            format: 'bracket',
            status: 'proximamente',
            prize: '100.000 ARG',
        ...
        },
        {
            ...
            image: 'images/logo SPOOKY CUP (1).png',
            game: 'mlbb',
            format: 'bracket',
            status: 'proximamente',
            prize: '100.000 ARG',
        ...
        },
        {
            ...
            image: 'images/logo TORNEO NAVIDARKS (1).png',
            game: 'mlbb',
            format: 'bracket',
            status: 'proximamente',
            prize: '100.000 ARG',
        ...
        },
        {
            ...
            image: 'images/logo TORNEO PRIMAVERA (1).png',
            game: 'mlbb',
            format: 'bracket',
            status: 'proximamente',
            prize: '100.000 ARG',
        ...
        },
        {
            ...
            image: 'images/logo TORNEO AMANECER (1).png',
            game: 'mlbb',
            format: 'bracket',
            status: 'abierto',
            prize: '100.000 ARG',
        ...
        },
        {
            ...
            image: 'images/logo LIGA SAKURA (1).png',
            game: 'mlbb',
            format: 'liga',
            status: 'proximamente',
            prize: '80.000 ARG',
        ...
        },
        {
            ...
            image: 'images/logo LIGA AMANECER (1).png',
            game: 'mlbb',
            format: 'liga',
            status: 'proximamente',
